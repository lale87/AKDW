...
\cite[1773]{GANA07}. In den meisten Fällen werden hierbei GET-Parameter genutzt.
Im Gegensatz zu POST-Parametern, welche im Hintergrund übertragen werden, hängen
GET-Parameter direkt an der aufgerufenen URL \cite[56]{SH06}. Durch diese ist es
möglich direkt auf dynamische Webseiten zu verlinken (z. B. einen bestimmten
...
Angreifer muss nur das Opfer dazu bewegen die manipulierte URL zu öffnen.
% Vom Server "reflektiert"
Da der Server beim Aufruf einer manipulierten URL die Möglichkeit hat, die
angehängten Parameter auf schädliche Werte zu überprüfen bevor er etwas an den
